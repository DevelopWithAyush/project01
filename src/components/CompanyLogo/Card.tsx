...
const Card = () => {
  return (
    <div className="py-[40px] px-[20.5px] bg-black border-[1px] border-solid border-[#FFF] border-opacity-20 rounded-[10px]  flex flex-col items-center justify-start gap-6 ">
      <div className="p-[18px] bg-[#FFF] rounded-[10px] flex flex-col items-center justify-center">
        <svg
      ...
      <div className="flex flex-col w-full items-center justify-start">
        <p className="text-white text-[18px] font-dm-sans-bold_700 leading-normal tracking-[-0.588px]">
          Lorem ipsum dolor sit
        </p>
        <p className="flex items-center justify-center text-white text-[16px] max-w-[319px] leading-[23px] tracking-[-0.16px] text-center text-balance">
          Lorem ipsum dolor sit amet consectetur. Gravida arcu velit a
          sollicitudin ullamcorper nibh tempor aenean donec. Volutpat eros.
        </p>
      </div>
    </div>
  );
