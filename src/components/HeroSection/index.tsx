...
const HeroSection = () => {
    ...
    >
                <section className="flex flex-col items-center justify-start container max-w-[88rem] mx-auto gap-8 py-[69px]  relative ">
                    <Image src={"/Images/image2.png"} alt="cursor" width={200} height={200} className="absolute translate-x-[100%] left-0 bottom-0 -translate-y-1/2"/>
                    <Image src={"/Images/image1.png"} alt="cursor" width={200} height={200} className="absolute -translate-x-[90%] right-0 top-0 translate-y-[100%]"/>
        <Button />
        ...
        <button className="text-black px-5 py-[15px] bg-white rounded-[10px] text-[16px] ">
          Get It Now
        </button>
      </section>
         </main>
      <svg
        ...
        className=" absolute top-[800px] left-1/2 -translate-x-1/2  "
      >
        <path
